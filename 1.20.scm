...
; Exercise 1.20: process that a procedure generates is of course dependent on
...
; substitution method (for normal order), illus- trate the process generated in
; evaluating (gcd 206 40) and indicate the remainder operations that are
; actually per- formed. How many remainder operations are actually per- formed
...
; (gcd (remainder 40 (remainder 206 40)) (remainder (remainder 206 40) (remainder 40 (remainder 206 40))) ; if 3
